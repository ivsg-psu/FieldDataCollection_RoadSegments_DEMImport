% script_test_fcn_DEMImport_bulkCopyPASDAListingsToLocalDrive.m
% tests fcn_DEMImport_bulkCopyPASDAListingsToLocalDrive.m

% REVISION HISTORY:
%
% 2026_04_02 by Sean Brennan, sbrennan@psu.edu
% - In script_test_fcn_DEMImport_bulkCopyPASDAListingsToLocalDrive
...
%% DEMO case: load pamap (9 TB)
figNum = 10001;
titleString = sprintf('DEMO case: load pamap (9 TB)');
...
%% DEMO case: load usgs (16.2 TB)
figNum = 10002;
titleString = sprintf('DEMO case: load usgs (16.2 TB)');
fprintf(1,'Figure %.0f: %s\n',figNum, titleString);
% figure(figNum); clf;
...
%% DEMO case: load lidar (23 TB)
figNum = 10003;
titleString = sprintf('DEMO case: load lidar (23 TB)');
fprintf(1,'Figure %.0f: %s\n',figNum, titleString);
% figure(figNum); clf;
...
%     fcn_DEMImport_bulkCopyPASDAListingsToLocalDrive(...
%     tempXYdata,...
%     start_definition,...
%     end_definition,...
