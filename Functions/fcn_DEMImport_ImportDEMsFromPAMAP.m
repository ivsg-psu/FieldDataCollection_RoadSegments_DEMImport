function fcn_DEMImport_ImportDEMsFromPAMAP(varargin)
% fcn_DEMImport_ImportDEMsFromPAMAP  imports PAMAP DEMs from the PASDA
% database
%
% FORMAT:
%
...
% EXAMPLES:
%
%     See the script: script_test_fcn_DEMImport_ImportDEMsFromPAMAP
