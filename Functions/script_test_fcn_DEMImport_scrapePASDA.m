% script_test_fcn_DEMImport_scrapePASDA.m
% tests fcn_DEMImport_scrapePASDA.m

% REVISION HISTORY:
%
% 2026_04_02 by Sean Brennan, sbrennan@psu.edu
% - In script_test_fcn_DEMImport_scrapePASDA
...
%% DEMO case: scrape directory
figNum = 10001;
titleString = sprintf('DEMO case: scrape PASDA directory');
